            ...
            <>
              ...
              <div className={`absolute transition-all duration-1500 ease-out ${
                stage === 'initial' 
                  ...
                  ? 'left-1/4 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-80'
                  : 'left-1/4 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-100'
              }`}>
                <img 
                  src="/lovable-uploads/a42a1abc-16cd-4410-8cf7-324a6c97ac20.png" 
                  alt="STEM for Society Logo" 
                  className={`object-contain transition-all duration-1500 ease-out ${
                    stage === 'initial' 
              ...
              {/* Text Element */}
              <div className={`absolute inset-0 flex items-center justify-center transition-all duration-1200 ease-out ${
                stage === 'initial' 
              ...
              {/* Login Form */}
              <div className={`absolute right-0 top-0 h-full w-1/2 flex items-center justify-center px-4 md:px-8 transition-all duration-800 ease-out ${
                stage === 'finalLayout' 
