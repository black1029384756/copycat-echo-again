  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        {/* Initial Centered Content - Logo and Text */}
        <div className="absolute inset-0 flex flex-col items-center justify-center animate-initial-fade-in">
          <div className="logo-container animate-logo-center-to-left">
            <img 
              src="/lovable-uploads/a42a1abc-16cd-4410-8cf7-324a6c97ac20.png" 
              alt="STEM for Society Logo" 
              className="h-32 w-32 md:h-48 md:w-48 lg:h-64 lg:w-64 object-contain"
            />
          </div>
          <div className="text-container animate-text-fade-out mt-8">
        ...
        {/* Final Split Layout */}
        <div className="absolute inset-0 flex opacity-0 animate-split-layout-fade-in">
          
          {/* Left Side - Final Logo Position */}
          <div className="w-1/2 flex items-center justify-center relative">
            <div className="final-logo-position">
              <img 
                src="/lovable-uploads/a42a1abc-16cd-4410-8cf7-324a6c97ac20.png" 
                alt="STEM for Society Logo" 
                className="h-48 w-48 md:h-64 md:w-64 lg:h-80 lg:w-80 object-contain animate-pulse-glow-delayed"
              />
            </div>
          </div>

          {/* Right Side - Login Form */}
          <div className="w-1/2 flex items-center justify-center px-4 md:px-8 animate-form-slide-in">
        ...
        {/* Mobile Layout */}
        <div className="md:hidden absolute inset-0 opacity-0 animate-mobile-layout-fade-in">
          {/* Mobile Logo */}
          ...
          <div className="flex-1 flex items-start justify-center px-4 pt-8">
            <Card className="w-full max-w-sm bg-white/95 backdrop-blur-md shadow-2xl border-0">
